...
class RobertaEncoder(nn.Module):
	...
	def forward(self, sentences):
		...
		'''
		# Preprocess sentences
		token_ids, attn_masks, input_lengths, index_retrieve, pad_word = self.robertify_input(sentences)

		# Feed through RoBERTa
		cont_reps, _ = self.roberta_layer(token_ids, attention_mask = attn_masks)

		return cont_reps, input_lengths, token_ids, index_retrieve, pad_word